...
#ifndef CARDWORKOUT_PROGRAMMATIC_SWIFT_H
#define CARDWORKOUT_PROGRAMMATIC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CardWorkout_Programmatic",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC24CardWorkout_Programmatic11AppDelegate")
...
SWIFT_CLASS("_TtC24CardWorkout_Programmatic8CWButton")
...
SWIFT_CLASS("_TtC24CardWorkout_Programmatic27CardSelectionViewController")
@interface CardSelectionViewController : UIViewController
- (void)viewDidLoad;
- (void)PresentRulesVC;
...
SWIFT_CLASS("_TtC24CardWorkout_Programmatic19RulesViewController")
...
SWIFT_CLASS("_TtC24CardWorkout_Programmatic13SceneDelegate")
